...
namespace Project.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private Repository<SmsConfig> _smsConfigRepository;

        public AccountController()
        {
        }

        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, Repository<SmsConfig> smsConfigRepository)
        {
        ...
        [ValidateAntiForgeryToken]
        [AllowAnonymous]
        public async Task<string> VerificationCode(string mobile)
        {
            // 发送手机验证码
        ...
        {
            if (TempData["PhoneCode"] == null || TempData["PhoneCode"].ToString() != model.PhoneCode)
            {
                // todo 手机验证码错误
            }
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            {
                // 请不要显示该用户不存在
                return RedirectToAction("ResetPasswordConfirmation", "Purview");
            }
