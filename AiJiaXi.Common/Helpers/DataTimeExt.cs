...
namespace AiJiaXi.Common.Helpers
{
    ...
    public static class DataTimeExt
    {
        ...
        /// <summary>
        /// 获得系统自身时间戳：为距离UTC 1970年1月1日零点的秒数
        /// </summary>
        /// <returns>系统当前时间戳</returns>
        public static long GetTimeStamp(this DateTime datatTime)
        {
            TimeSpan ts = datatTime - DateTime.Parse("1970-1-1  00:00:00");
